...
define('IMSOURCES_DB_VERSION', 1.03);
 ...
 */
/*function imsources_db_upgrade_1() {
}
function imsources_db_upgrade_2() {
}*/

function icms_module_update_imsources($module) {
	/**
...
function icms_module_install_imsources($module) {
