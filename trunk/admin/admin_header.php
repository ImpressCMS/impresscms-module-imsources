...
include_once(IMSOURCES_ROOT_PATH . 'include/requirements.php');
...
*/
if (is_object($icmsModule) && $icmsModule->dirname() == IMSOURCES_DIRNAME) {
	// We are in the module
	if (defined('XOOPS_CPFUNC_LOADED')) {
		// We are in the admin side of the module
		if (!$icmsModule->getDBVersion()) {
			redirect_header(ICMS_URL . '/modules/system/admin.php?fct=modulesadmin&op=update&module=' . IMSOURCES_DIRNAME, 4, _AM_IMSOURCES_FIRST_USE);
			exit;
		}
	}
}
